...
def main():
    ...
    for muB in muBs:
        ...
        pressure = eos_module.evaluate_pressure(chempots, parameters, sigma) - \
        ...
        for i in range(2):
            n_c = 3
            k_f_sqr = chempots[i] ** 2 - quark_mass ** 2
            if k_f_sqr > 0:
        ...
        for i in range(2, 4):
            k_f_sqr = chempots[i] ** 2 - nucleon_mass ** 2
            if k_f_sqr > 0:
        ...
        nucleon_mass_star = eos_module.nucleon_mass_parity_model(
            sigma, '-', parameters.a_coupling, parameters.b_coupling, parameters.mass_amplitude, m_q_bare)
        for i in range(4, 6):
            k_f_sqr = chempots[i] ** 2 - nucleon_mass_star ** 2
            if k_f_sqr > 0:
                densities[i] = (k_f_sqr ** 1.5) / (3 * np.pi ** 2)
        ...
        output.write(
            f" {energy_density:20.10e} {pressure:20.10e} {nB:20.10e} {muB:20.10e} {densities[0]:20.10e} {densities[1]:20.10e} {densities[2]:20.10e} {densities[3]:20.10e} {densities[4]:20.10e} {densities[5]:20.10e} {quark_mass:20.10e} {nucleon_mass:20.10e} {nucleon_mass_star:20.10e} {sigma:20.10e} {sigma_res[2] * sigma:20.10e}\n")
